...
SCMR  # (monkey_island\cc\services\reporting\issue_processing\exploit_processing\exploiter_descriptor_enum.py:52)
...
ScmrExploiter  # (\monkey\infection_monkey\exploit\scmrexec.py:15)
